# Overview #
Simple Python script that converts the MotoACTV CSV format to TCX. Useful for uploading MotoACTV workouts to sites like [Strava](http://www.strava.com) or [RunKeeper](http://www.runkeeper.com).
...
# Usage #
./motoactv_tcx.py <CSV file> | tidy -i -xml (| pbcopy)
